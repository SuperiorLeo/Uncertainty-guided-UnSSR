...
class SERT(nn.Module):
    def __init__(self, 
        ...
        # self.conv_first2 = nn.Conv2d(out_channels, dim, 3, 1, 1)
        ...
        self.conv_delasta = nn.Conv2d(dim,out_channels, 3, 1, 1)
...
if __name__ == "__main__":
    ...
    '''
    Parameters number is  3608120
    Parameters number is 3552824.0; Flops: 228918624256.0
    '''