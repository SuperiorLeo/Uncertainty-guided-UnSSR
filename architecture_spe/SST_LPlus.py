...
class SST_block(nn.Module):
    def __init__(self, dim=28):
        ...
        self.downTranspose_0_0 = nn.Conv2d(dim, 2*dim, 4, 2, 1, bias=False)
        ...
        # Bottleneck_spectral
        self.bottleneck_2_2 = SpectralAB(dim=dim*4, dim_head=dim, heads=112 // dim, num_blocks=1)
        ...
        self.up_1_3 = SpectralAB(dim=dim*2, num_blocks=1, dim_head=dim, heads=56 // dim)
        ...
        self.up_0_4 = SpectralAB(dim=dim, num_blocks=1, dim_head=dim, heads=28 // dim)
        ...
        self.up_0_5 = SpectralAB(dim=dim, num_blocks=1, dim_head=dim, heads=28 // dim)
...
class SST_LPlus(nn.Module):
    def __init__(self, in_channels=28, out_channels=28, n_feat=28, stage=1):
        ...
        self.conv_in0 = nn.Conv2d(3, n_feat, kernel_size=3, padding=(3 - 1) // 2, bias=False)
        # 1-stg
        ...
        self.fution1 = nn.Conv2d(62, 31, 1, padding=0, bias=True)
        ...
        self.fution2 = nn.Conv2d(62, 31, 1, padding=0, bias=True)
        ...
        self.fution3 = nn.Conv2d(62, 31, 1, padding=0, bias=True)
        ...
        self.fution4 = nn.Conv2d(62, 31, 1, padding=0, bias=True)
        ...
        self.fution5 = nn.Conv2d(62, 31, 1, padding=0, bias=True)
        ...
        self.fution6 = nn.Conv2d(62, 31, 1, padding=0, bias=True)
        ...
        self.fution7 = nn.Conv2d(62, 31, 1, padding=0, bias=True)
        ...
        self.fution8 = nn.Conv2d(62, 31, 1, padding=0, bias=True)
        ...
        self.fution9 = nn.Conv2d(62, 31, 1, padding=0, bias=True)
    ...
    def forward(self, y):
        ...
        # if mask==None:
        #     mask = torch.rand((1,31,256,256)).cuda()
        y = self.conv_in0(y)
...
if __name__ == "__main__":
    ...
    model = SST_LPlus(in_channels=31, out_channels=31, n_feat=31, stage=1).cuda()
    ...
    print('Parameters number is {}; Flops: {}'.format((params/1000000),(macs/1000000000)))
    print(torch.__version__)
    '''
    1 Parameters number is 0.432361; Flops: 16.755851264
    '''