...
class Restormer(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        idx = self.sort(out_dec_level1[:, :, :h_inp, :w_inp])

        return out_dec_level1[:, :, :h_inp, :w_inp], idx
...
if __name__ == "__main__":
    ...
    '''
Parameters number is  15108706
Parameters number is 15093271.0; Flops: 342439002112.0
    '''