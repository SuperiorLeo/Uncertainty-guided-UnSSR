        ...
        for i in range(stage):
            self.encoder_layers.append(nn.ModuleList([
                CAB(
                    ...
                    dim=dim_stage, num_blocks=num_blocks[0], dim_head=dim, heads=dim_stage // dim,attention_type = attention_type),
        ...
        for i in range(stage):
            self.decoder_layers.append(nn.ModuleList([
                ...
                CAB(
                    ...
                    dim=dim_stage // 2, num_blocks=num_blocks[-1], dim_head=dim,
...
if __name__ == "__main__":
    ...
    model = SPECAT(dim=36, stage=1, num_blocks=[2,1],attention_type = 'full')

    with torch.no_grad():
        output_tensor,_ = model(input_tensor, None)
    ...
    '''
    256 Parameters number is 0.432361; Flops: 16.755851264
    512 Parameters number is 0.390385; Flops: 55.838244864
    '''
