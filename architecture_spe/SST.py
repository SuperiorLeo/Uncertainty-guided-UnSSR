...
class SST(nn.Module):
    ...
    def __init__(self, 
        ...
        # self.output2 = nn.Conv2d(int(dim), output_channels, 3,1,1)
        self.conv_delasta = nn.Conv2d(dim,output_channels, 3, 1, 1)  #reconstruction from features
    ...
    def forward(self, inp_img):
        ...
        x = self.output(x+f1) 
        # print(x.shape) # torch.Size([1, 90, 256, 256])
        # x = self.output2(x)
        x = self.conv_delasta(x)
...
if __name__ == "__main__":
    ...
    print('Parameters number is {}; Flops: {}'.format(params,(macs/1000000000)))
    print(torch.__version__)
    '''
    Parameters number is  4122158
    Parameters number is 4073342.0; Flops: 268.975931392
    '''